...
namespace OpenCVForUnityExample
{
    ...
    public class Script_MainScene : MonoBehaviour
    {
        /// <summary>
        ...
        public Point monPoint;
        public int nbFinger;

        public Slider unslide; 

        public Script_DragAndDrop unScript;
...
//                Imgproc.putText (rgbaMat, "Please touch the area of the open hand.", new Point (5, rgbaMat.rows () - 10), Imgproc.FONT_HERSHEY_SIMPLEX, 1.0, new Scalar (255, 255, 255, 255), 2, Imgproc.LINE_AA, false);
        ...
        void HandPoseEstimationProcess (Mat rgbaMat)
        {
